...
TITLE		:=	Funny Mamba Autoloader Installer v1.10
APPID		:=	MAMBAINST
...
CFLAGS		=	-O2 -Wall -DENABLE_LOG -mcpu=cell --std=gnu99 $(MACHDEP) $(INCLUDE)
CXXFLAGS	=	$(CFLAGS)
...
#---------------------------------------------------------------------------------
LIBS	:= -lfreetype -lfont -ltiny3d -lsysfs -lpngdec -lgcm_sys -lio -lsysutil -lm -llv2 -lsysmodule -lz
